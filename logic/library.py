...
SONGS = [
    ...
    Song("Blackbirds",
         ...
         "logic/new resource/lancey-foux.jpg"),
    ...
    Song("Ensalada",
         ...
         "logic/new resource/freddie-gibbs.jpg"),
    ...
    Song("Good Flirts",
         ...
         "logic/new resource/baby-keem.jpg"),
    ...
    Song("Bazooka",
         ...
         "logic/new resource/bazooka.jpg"),
    ...
    Song("You're the Best",
         ...
         "logic/new resource/joe-esposito.jpg"),
    ...
    Song("Chicago",
         ...
         "logic/new resource/micheal-jackson.jpg"),
    ...
    Song("Ex-Factor",
         ...
         "logic/new resource/lauryn-hill.jpg"),
    ...
    Song("Gin and Juice",
         ...
         "logic/new resource/snoop-dogg.jpg"),
    ...
    Song("Hips Don't Lie",
         ...
         "logic/new resource/shakira.jpg"),
    ...
    Song("Get Lucky",
         ...
         "logic/new resource/pharell-williams.jpg"),
    ...
    Song("No One",
         ...
         "logic/new resource/alicia-keys.jpg"),
    ...
    Song("Sky",
         ...
         "logic/new resource/playboi-carti.jpg"),
    ...
    Song("Last Friday Night (T.G.I.F.)",
         ...
         "logic/new resource/katy-perry.jpg"),
    ...
    Song("Umbrella",
         ...
         "logic/new resource/rihanna.jpg"),
    ...
    Song("Firework",
         ...
         "logic/new resource/katty-perry.jpg"),
    ...
    Song("Stronger",
         ...
         "logic/new resource/kanye west.jpg"),
    ...
    Song("SDP Interlude",
         ...
         "logic/new resource/travis scott.jpg"),
    ...
    Song("Lights",
         ...
         "logic/new resource/ellie goulding.jpg"),
    ...
    Song("Lush Life",
         ...
         "logic/new resource/zara larsson.jpg"),
